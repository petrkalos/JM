...
extern void sample_reconstruct2 (imgpel **curImg, imgpel **mb_pred, int **mb_rres, int mb_y,int mb_x, int opix_x, int width, int height, int max_imgpel_value, int dq_bits,int pl,Macroblock *currMB);
#endif
