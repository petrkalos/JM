               ...
               int joff)             //!< index to 4x4 block
{
  ...
  sample_reconstruct2 (&currSlice->mb_rec[pl][joff], &currSlice->mb_pred[pl][joff], &mb_rres[joff],joff,ioff, ioff, BLOCK_SIZE, BLOCK_SIZE, currMB->p_Vid->max_pel_value_comp[pl], DQ_BITS,pl,currMB);
}
